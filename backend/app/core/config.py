...
class Settings(BaseModel):
    ...
    VERSION: str = "1.0.0"
    DESCRIPTION: str = (
        "Sistema web para controle de processos e gestão de cálculos"
    )
    ...
    def load_from_env(cls):
        ...
        return cls(
            ...
            PROJECT_NAME=os.getenv(
                "PROJECT_NAME", "Sistema de Gestão de Processos"
            ),
            ...
            FROM_EMAIL=os.getenv(
                "FROM_EMAIL", "noreply@gestaoprocessos.com"
            ),
            FROM_NAME=os.getenv(
                "FROM_NAME", "Sistema Gestão Processos"
            ),
            ...
            DATAJUD_RATE_LIMIT_PER_MINUTE=int(
                os.getenv("DATAJUD_RATE_LIMIT_PER_MINUTE", "60")
            ),
