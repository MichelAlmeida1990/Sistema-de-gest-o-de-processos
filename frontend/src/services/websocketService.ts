...
class WebSocketService {
    ...
    return new Promise((resolve, reject) => {
      ...
      try {
        ...
        this.ws.onclose = (event) => {
          ...
          // Desabilitar reconexão automática temporariamente para evitar spam
          // TODO: Investigar problema do WebSocket e reativar reconexão
          console.log('Reconexão automática desabilitada temporariamente')
        }
  ...
  private handleMessage(message: WebSocketMessage): void {
    // Só fazer log de mensagens importantes (não pong)
