...
import { createProcessNotification } from '../store/notificationStore'
    ...
    try {
      ...
      if (editingProcess) {
        ...
        createProcessEvent(
          ...
          user?.name || 'Usuário',
          {
            oldStatus: editingProcess.status,
        ...
        // Criar evento de criação na timeline
        createProcessEvent(
          'created',
          values.number,
          user?.name || 'Usuário',
          {
            client: values.client,
            court: values.court || 'Tribunal',
            status: values.status,
            value: values.value
          }
        )
        
        // Criar notificação de novo processo
