  ...
  const stats = [
    {
      ...
      value: mainMetrics.activeProcesses,
      prefix: <FileTextOutlined />,
      suffix: '',
      trend: `+${processCompletionRate}%`,
      trendDirection: 'up',
      color: '#00afee'
    },
    {
      title: 'Tarefas Concluídas',
      value: mainMetrics.completedTasks,
    ...
    },
    {
      ...
      value: mainMetrics.totalFiles,
      prefix: <DollarOutlined />,
      suffix: '',
      trend: `+${mainMetrics.recentTasks} novos`,
      trendDirection: 'up',
      color: '#722ed1'
    }
  ]
