...
import {
  ...
  DollarOutlined, SendOutlined, BarChartOutlined
...
export const DashboardPage: React.FC = () => {
  ...
  const gradientStyles = {
    hero: {
      background: darkMode 
        ? 'linear-gradient(135deg, #031f5f 0%, #00afee 50%, #ca00ca 100%)'
        : 'linear-gradient(135deg, #031f5f 0%, #00afee 30%, #ffffff 100%)',
  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        right: '20px', 
        zIndex: 1000,
        background: gradientStyles.card.background,
        backdropFilter: gradientStyles.card.backdropFilter,
        border: gradientStyles.card.border,
        borderRadius: '12px',
        padding: '8px 16px',
        boxShadow: gradientStyles.card.boxShadow
      }}>
        <Space>
          ...
          <Col xs={24} sm={12} lg={6} key={index}>
            <Card
              ...
              onMouseLeave={(e) => {
                ...
                e.currentTarget.style.boxShadow = gradientStyles.card.boxShadow
              }}
            >
              <Statistic
                title={
