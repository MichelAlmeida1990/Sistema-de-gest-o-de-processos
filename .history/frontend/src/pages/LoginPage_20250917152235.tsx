...
export const LoginPage: React.FC = () => {
  ...
  const handleLogin = async (values: LoginForm) => {
    debugLogger.log('LOGIN_PAGE', 'HANDLE_LOGIN', { 
      email: values.email, 
    ...
    if (values.email === 'http://localhost:3000/login') {
      debugLogger.log('LOGIN_PAGE', 'EMAIL_ERROR', { 
        message: 'Email is URL instead of actual email!',
        receivedEmail: values.email
      })
      message.error('Erro: Email inválido detectado. Por favor, digite um email válido.')
      return
    }
    ...
    try {
      ...
      debugLogger.log('LOGIN_PAGE', 'LOGIN_ERROR', { error: error.message })
          ...
          >
            ...
            >
              <Input
                ...
                onChange={(e) => {
                  debugLogger.log('LOGIN_PAGE', 'EMAIL_INPUT_CHANGE', { 
                    value: e.target.value,
                    valueLength: e.target.value.length
                  })
                }}
                onFocus={(e) => {
                  debugLogger.log('LOGIN_PAGE', 'EMAIL_INPUT_FOCUS', { 
                ...
                onBlur={(e) => {
                  debugLogger.log('LOGIN_PAGE', 'EMAIL_INPUT_BLUR', { 
