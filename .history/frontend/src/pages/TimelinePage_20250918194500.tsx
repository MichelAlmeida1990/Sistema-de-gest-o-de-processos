...
export const TimelinePage: React.FC = () => {
  ...
  // Os eventos agora vêm do store centralizado
  ...
  const handleModalOk = async () => {
    try {
      ...
      if (editingEvent) {
        // Para edição, por enquanto apenas mostra sucesso
        // Em uma implementação real, você criaria uma função de update no store
        message.success('Evento atualizado com sucesso!')
      } else {
        // Criar novo evento usando o store
        addEvent({
          type: values.type,
          title: values.title,
