...
async def get_admin_dashboard():
    ...
    try:
        # TODO: Implementar dados reais do dashboard
        return {
            "summary": {
                "total_processes": 150,
            ...
            "recent_activity": [
                {
                    "id": 1,
                    "type": "task_completed",
                    "description": "Tarefa 'Cálculo de Pensão' concluída",
                    "user": "João Calculista",
                    "timestamp": "2024-01-01T12:00:00Z"
                },
                {
                    "id": 2,
                    "type": "process_created",
                    "description": "Novo processo cadastrado",
                    "user": "Maria Admin",
            ...
            "charts": {
                "tasks_by_status": [
                    ...
                    {"status": "em_andamento", "count": 30},
                    {"status": "concluida", "count": 255}
                ],
                "payments_by_month": [
                    {"month": "2024-01", "amount": 15000.00},
                    {"month": "2024-02", "amount": 18000.00}
                ]
            }
        }
