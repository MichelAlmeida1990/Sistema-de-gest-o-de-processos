...
async def get_system_statistics(
    ...
    try:
        metrics_data = DashboardService.get_system_metrics(db)
        return {
            "metrics": metrics_data,
            "database": {
                "size": "2.5 GB",  # TODO: implementar tamanho real do banco
                "tables": 15,
                "records": 50000
            },
            "performance": {
                "avg_response_time": "150ms",  # TODO: implementar métricas reais
                "uptime": "99.9%",
                "requests_per_minute": 120
            },
            "storage": {
                "total_space": "100 GB",  # TODO: implementar dados reais de storage
                "used_space": "25 GB",
