...
class User(BaseModel):
    ...
    # Relacionamentos
    processes = relationship("Process", back_populates="user", foreign_keys="Process.user_id")
    ...
    timeline_events = relationship("TimelineEvent", back_populates="user", foreign_keys="TimelineEvent.user_id")
